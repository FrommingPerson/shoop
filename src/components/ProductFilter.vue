...
export default defineComponent({
  name: "ProductFilter",
  props: ["priceFrom", "priceTo", "categoriesId"],
  data() {
    return {
      currentPriceFrom: 0,
      currentPriceTo: 0,
  ...
  methods: {
    admit() {
      ...
      this.$emit("update:categoriesId", this.currentCategoryId);
    },
  },
});
</script>
...
<template>
      <aside class="filter">
        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent = "admit()">
